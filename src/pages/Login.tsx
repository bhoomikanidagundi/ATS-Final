  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-slate-900 dark:text-slate-100 transition-colors">
      ...
      <div className="flex-1 flex items-center justify-center p-4 relative z-10">
        <div className="w-full max-w-md bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-2 border-slate-900 dark:border-slate-800 rounded-[32px] p-8 sm:p-12 shadow-[8px_8px_0px_0px_rgba(15,23,42,1)] dark:shadow-[8px_8px_0px_0px_rgba(15,23,42,0.5)] transition-colors">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-black tracking-tight text-slate-900 dark:text-white uppercase transition-colors">Welcome Back</h2>
            <p className="text-slate-500 dark:text-slate-400 font-medium mt-2 transition-colors">Log in to track your optimizations.</p>
          </div>
          ...
          <p className="mt-8 text-center text-sm font-bold text-slate-500 dark:text-slate-400 transition-colors">
            ...
            <Link to="/signup" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 uppercase tracking-widest transition-colors">
              Sign up
            </Link>
          </p>
        </div>
